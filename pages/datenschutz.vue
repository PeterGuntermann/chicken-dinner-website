...
<template>
  ...
  <div class="container">
    ...
    <p>Peter Guntermann<br />Haydnstraße 6<br />76356 Weingarten</p>
    <p>E-Mail-Adresse:</p>
    <p><a href="mailto:info@chickendinnerband.de">info@chickendinnerband.de</a></p>
    <p>Impressum:</p>
    <p>
      <a href="impressum.html" target="_blank" rel="noopener"
        >https://chickendinnerband.de/impressum.html</a
      >
    </p>
    ...
    <p>
      SSL-Verschlüsselung (https): Um Ihre via unserem Online-Angebot übermittelten Daten
    ...
    <p>
      ...
      datenschutzrechtlichen Rechtsgrundlage wir die personenbezogenen Daten der Nutzer
      mit Hilfe von Cookies verarbeiten, hängt davon ab, ob wir Nutzer um eine
    ...
    <ul>
      <li>
        ...
        Online-Angebot verlassen und sein Endgerät (z.B. Browser oder mobile Applikation)
        geschlossen hat.
      </li>
      <li>
        <strong>Permanente Cookies:</strong> Permanente Cookies bleiben auch nach dem
        Schließen des Endgerätes gespeichert. So können beispielsweise der Login-Status
        gespeichert oder bevorzugte Inhalte direkt angezeigt werden, wenn der Nutzer eine
        Website erneut besucht. Ebenso können die mit Hilfe von Cookies erhobenen Daten
    ...
    <p>
      ...
      Widerspruch gegen die Verarbeitung entsprechend den gesetzlichen Vorgaben im Art. 21
      DSGVO einlegen. Nutzer können ihren Widerspruch auch über die Einstellungen ihres
      Browsers erklären, z.B. durch Deaktivierung der Verwendung von Cookies (wobei
      dadurch auch die Funktionalität unserer Online-Dienste eingeschränkt sein kann). Ein
      Widerspruch gegen die Verwendung von Cookies zu Online-Marketing-Zwecken kann auch
      über die Websites
    ...
    <ul class="m-elements">
      <li>
        ...
        Rahmen des Cookie-Einwilligungs-Management-Verfahrens genannten Verarbeitungen und
    ...
    <ul class="m-elements">
      <li>
        ...
        der Sicherheit eingesetzt werden, z.B., um eine Überlastung der Server zu
        ...
        sicherzustellen; <strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6
    ...
    <p>
      ...
      an der Beantwortung der Anfragen und Pflege von Nutzer- bzw. Geschäftsbeziehungen.
    </p>
    <ul class="m-elements">
      <li>
      ...
      <li>
        ...
        Kundenservice; Kontaktanfragen und Kommunikation; Verwaltung und Beantwortung von
        Anfragen; Feedback (z.B. Sammeln von Feedback via Online-Formular); Bereitstellung
    ...
    <ul class="m-elements">
      <li>
        ...
        oder andere Kommunikationswege mit uns in Kontakt treten, verarbeiten wir die uns
        in diesem Zusammenhang mitgeteilten Daten zur Bearbeitung des mitgeteilten
        Anliegens. Zu diesem Zweck verarbeiten wir personenbezogene Daten im Rahmen
        vorvertraglicher und vertraglicher Geschäftsbeziehungen, soweit dies zu deren
        Erfüllung erforderlich ist und im Übrigen auf Grundlage unserer berechtigten
        Interessen sowie der Interessen der Kommunikationspartner an der Beantwortung der
        Anliegen und unserer gesetzlichen Aufbewahrungspflichten;
        <strong>Rechtsgrundlagen:</strong> Vertragserfüllung und vorvertragliche Anfragen
        (Art. 6 Abs. 1 S. 1 lit. b. DSGVO), Berechtigte Interessen (Art. 6 Abs. 1 S. 1
        lit. f. DSGVO).
      </li>
    ...
    <ul class="m-elements">
      <li>
        <strong>Matomo: </strong>Bei Matomo handelt es sich um eine Software, die zu
        Zwecken der Webanalyse und Reichweitenmessung eingesetzt wird. Im Rahmen der
        Nutzung von Matomo werden Cookies erzeugt und auf dem Endgerät der Nutzer
        gespeichert. Die im Rahmen der Nutzung von Matomo erhobenen Daten der Nutzer
        werden nur von uns verarbeitet und nicht mit Dritten geteilt. Die Cookies werden
        für einen maximalen Zeitraum von 13 Monaten gespeichert:
        <a href="https://matomo.org/faq/general/faq_146/" target="_blank" rel="noopener"
          >https://matomo.org/faq/general/faq_146/</a
        >; <strong>Rechtsgrundlagen:</strong> Einwilligung (Art. 6 Abs. 1 S. 1 lit. a.
        DSGVO); <strong>Löschung von Daten:</strong> Die Cookies haben eine Speicherdauer
    ...
    <ul class="glossary">
      ...
      <li>
        ...
        Demographie, Verhalten und Interessen, wie z.B. die Interaktion mit Webseiten und
        deren Inhalten, etc.) zu analysieren, zu bewerten oder, um sie vorherzusagen (z.B.
        die Interessen an bestimmten Inhalten oder Produkten, das Klickverhalten auf einer
      ...
      <li>
        ...
        Onlineangebotes und kann das Verhalten oder Interessen der Besucher an bestimmten
        Informationen, wie z.B. Inhalten von Webseiten, umfassen. Mit Hilfe der
        Reichweitenanalyse können Webseiteninhaber z.B. erkennen, zu welcher Zeit Besucher
        ihre Webseite besuchen und für welche Inhalte sie sich interessieren. Dadurch
